...
namespace Trakit.Imaging {
	...
	/// </summary>
	public sealed class TrakitDeviceCommander : TrakitCommander, IDisposable {
		/// <summary>
		...
		public TrakitDeviceCommander() : this(new Uri(URI_PROD)) { }
		public TrakitDeviceCommander(Uri baseAddress) {
